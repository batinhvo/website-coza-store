...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('public/backend/images/favicon/favicon.ico')}}" />
  ...
  <body>
    ...
    <!-- <div class="buy-now">
      <a
        href="https://themeselection.com/products/CozaStore-bootstrap-html-admin-template/"
        target="_blank"
