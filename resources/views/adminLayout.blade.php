...
<html
  ...
  data-assets-path="public/dashboard/"
...
>
  <head>
    ...
    <title>Dashboard - Analytics | CozaStore</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">CozaStore</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{URL::to('/add-category-product')}}" class="menu-link">
                    <div data-i18n="Account">Add Category</div>
                  </a>
                </li>                
                <li class="menu-item">
                  <a href="{{URL::to('/all-category-product')}}" class="menu-link">
                    <div data-i18n="Connections">List Of All Category</div>
                  </a>
                </li>
              </ul>
            </li>
