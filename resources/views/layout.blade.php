	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<div class="p-t-27">
						...
						<a href="https://google.com" target="_blank" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
			...
			<div class="p-t-40">
				...
				<p class="copyright stext-107 cl6 txt-center">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">TinhVo</a> &amp; distributed by <a href="https://websitene.com" target="_blank">Website Nè</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<h4 class="mtext-105 cl2 js-name-detail p-b-14" id="product-name"></h4>
							<span class="mtext-106 cl2" id="product-price"></span>
							<p class="stext-102 cl3 p-t-23" id="product-desc"></p>
							<!--  -->
							<div class="p-t-33">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="time">
												...
												<option id="size-name">Size S</option>
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<a href="" id="link-detail" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
											View Detail
										</a>
									</div>
								</div>	
	...
	<script>
		$(document).ready(function() {
			$('.js-show-modal1').click(function() {
				var id = $(this).data('id');
				$.ajax({
					url: '/website-coza-store/view-product/' + id,
					method: 'GET',
					success: function(response) {
						$('#product-name').html(response.pro_name);
						$('#product-price').html(response.pro_price);
						$('#product-desc').html(response.pro_desc);
						$('#product-id').html(response.pro_id);
						var data = "/website-coza-store/product-detail/" + response.pro_slug + "/" + id;
						document.getElementById('link-detail').setAttribute('href', data);
					},
					error: function(xhr, status, error) {
						$('.js-modal1 .row').html('Đã xảy ra lỗi: ' + error);
					}
				});
			});
		});
